...
// texture
const BaseTexture = new THREE.TextureLoader
BaseTexture.load('./textures/shoe_baseColor.png')
const NormalTexture = new THREE.TextureLoader
NormalTexture.load('./textures/shoe_normal.png')
const  rougnessTexture = new THREE.TextureLoader
rougnessTexture.load('./textures/shoe_normal.png')
